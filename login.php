  ...
  <div class="cont">
    <div class="form sign-in">
      ...
      <form method="post" action="login.php" id="sign_in_form">
        ...
        <button class="submit" id="sign_in" name="student_login">Sign In</button>
        <a href="faculty_login.php"><button type="button" class="fb-btn"><span>Continue as faculty member</span></button></a>
      </form>
    </div>
